...
void RendererOpenGL::render() {
    ...
    if (shaderNeedsNewProjectionMatrix_) {
        ...
        Matrix4 projectionMatrix = glm::ortho(
            -kProjectionHalfHeight * aspect, kProjectionHalfHeight * aspect,
            -kProjectionHalfHeight, kProjectionHalfHeight,
...
void RendererOpenGL::init() {
    ...
    shader_ = std::unique_ptr<ShaderOpenGL>(
            ShaderOpenGL::loadShader(vertex, fragment, "inPosition", "inUV", "uProjection"));
    assert(shader_);
...
void RendererOpenGL::updateRenderArea() {
    EGLint width;
 ...
 */
void RendererOpenGL::createModels() {
    /*
     * This is a square:
     * 0 --- 1
     * | \   |
